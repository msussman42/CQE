...
\section{Control and optimization of numerical models for simulating
  quantum computers}

\begin{itemize}
\item Günther et al\cite{9651392}
\end{itemize}
Open quantum systems\cite{lidar2019lecture}

\begin{eqnarray}
\dot{\rho}(t)=-i[H(t),\rho(t)]+\ell(\rho(t))
\end{eqnarray}
\begin{eqnarray}
...
\end{eqnarray}
\begin{eqnarray}
\cal G(\bmalpha)=\frac{1}{M}\sum_{i=1}^{M} ....
\end{eqnarray}
...
1. compare VQE on classical computer vs IBM hardware to demonstrate the need
for improved hardware.

2. compare QUANDARY to other quantum optimal control algorithms. inverse
problems.

3. compare Error correction algorithms.

4. compare emulator algorithms and compare algorithms for emulating a
``NISQC''

5. quantum and hybrid classical/quantum algorithms for benchmarking quantum 
computers.
