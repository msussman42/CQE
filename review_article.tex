...
2. compare QUANDARY to other quantum optimal control algorithms.

3. compare Error correction algorithms.

4. VQE, QAOA

5. A proposed, realistic, computational chemistry problem that a 
quantum computer can do really well (with the right algorithm) but out of
reach for a classical computer.
