...
MatrixA=[1,-2,-1;0,0,0;0,-1,1]+1i*[0,-1,1;0,1,0;0,0,-1];
MatrixC=[-1,1;0,0;0,1]+1i*[1,0;0,1;-1,-2];
MatrixF=[0,0;1,-1]+1i*[2,1;0,1];
...
x11_true=(21/40)-(33/40)*1i;
x12_true=(-9/8)+(5/8)*1i;
x21_true=(1/2)+(1/4)*1i;
x22_true=(3/4)-(1/2)*1i;
x31_true=(-6/5)+(21/20)*1i;
x32_true=(-13/20)+(9/5)*1i;

real_X=[real(x11_true);real(x21_true);real(x31_true);real(x12_true);real(x22_true);real(x32_true);imag(x11_true);imag(x21_true);imag(x31_true);imag(x12_true);imag(x22_true);imag(x32_true)];
...
disp(MatrixX);
ZnnRightHandSide=-gamma*AFMlinear(MatrixX*MatrixF-MatrixA*conj(MatrixX)-MatrixC);
...
for s=1:num
    ...
    f11.NumberTitle='off';
    semilogy(tk(1,1:end-1)*(1/tau),err(1,:,s,1,1),'r--','LineWidth',4);set(gca,'FontSize',16);hold on
    ...
    figProperties = {
        ...
        {'X31_real_solve', Ytt(3,:), xt_1(3,:), '$y_{\mathrm{r},31}(\tau)$', '$x_{\mathrm{r},31}(\tau)$', 'r'}, ...
        {'X12_real_solve', Ytt(4,:), xt_1(4,:), '$y_{\mathrm{r},12}(\tau)$', '$x_{\mathrm{r},12}(\tau)$', 'r'}, ...
        {'X22_real_solve', Ytt(5,:), xt_1(5,:), '$y_{\mathrm{r},22}(\tau)$', '$x_{\mathrm{r},22}(\tau)$', 'r'}, ...
        {'X32_real_solve', Ytt(6,:), xt_1(6,:), '$y_{\mathrm{r},32}(\tau)$', '$x_{\mathrm{r},32}(\tau)$', 'r'}, ...
        {'X11_imaginary_solve', Ytt(7,:), xt_1(7,:), '$y_{\mathrm{i},11}(\tau)$', '$x_{\mathrm{i},11}(\tau)$', 'r'}, ...
        {'X21_imaginary_solve', Ytt(8,:), xt_1(8,:), '$y_{\mathrm{i},21}(\tau)$', '$x_{\mathrm{i},21}(\tau)$', 'r'}, ...
        {'X31_imaginary_solve', Ytt(9,:), xt_1(9,:), '$y_{\mathrm{i},31}(\tau)$', '$x_{\mathrm{i},31}(\tau)$', 'r'}, ...
        {'X12_imaginary_solve', Ytt(10,:), xt_1(10,:), '$y_{\mathrm{i},12}(\tau)$', '$x_{\mathrm{i},12}(\tau)$', 'r'}, ...
        {'X22_imaginary_solve', Ytt(11,:), xt_1(11,:), '$y_{\mathrm{i},22}(\tau)$', '$x_{\mathrm{i},22}(\tau)$', 'r'}, ...
        {'X32_imaginary_solve', Ytt(12,:), xt_1(12,:), '$y_{\mathrm{i},32}(\tau)$', '$x_{\mathrm{i},32}(\tau)$', 'r'}
        };
    ...
    if gamma_is_real,
        ...
        figPropertiesReal = {
            ...
            {'X31_real_solve', Ytt(3,:), xt_2(3,:), '$y_{\mathrm{r},31}(\tau)$', '$x_{\mathrm{r},31}(\tau)$', 'g'}, ...
            {'X12_real_solve', Ytt(4,:), xt_2(4,:), '$y_{\mathrm{r},12}(\tau)$', '$x_{\mathrm{r},12}(\tau)$', 'g'}, ...
            {'X22_real_solve', Ytt(5,:), xt_2(5,:), '$y_{\mathrm{r},22}(\tau)$', '$x_{\mathrm{r},22}(\tau)$', 'g'}, ...
            {'X32_real_solve', Ytt(6,:), xt_2(6,:), '$y_{\mathrm{r},32}(\tau)$', '$x_{\mathrm{r},32}(\tau)$', 'g'}, ...
            {'X11_imaginary_solve', Ytt(7,:), xt_2(7,:), '$y_{\mathrm{i},11}(\tau)$', '$x_{\mathrm{i},11}(\tau)$', 'g'}, ...
            {'X21_imaginary_solve', Ytt(8,:), xt_2(8,:), '$y_{\mathrm{i},21}(\tau)$', '$x_{\mathrm{i},21}(\tau)$', 'g'}, ...
            {'X31_imaginary_solve', Ytt(9,:), xt_2(9,:), '$y_{\mathrm{i},31}(\tau)$', '$x_{\mathrm{i},31}(\tau)$', 'g'}, ...
            {'X12_imaginary_solve', Ytt(10,:), xt_2(10,:), '$y_{\mathrm{i},12}(\tau)$', '$x_{\mathrm{i},12}(\tau)$', 'g'}, ...
            {'X22_imaginary_solve', Ytt(11,:), xt_2(11,:), '$y_{\mathrm{i},22}(\tau)$', '$x_{\mathrm{i},22}(\tau)$', 'g'}, ...
            {'X32_imaginary_solve', Ytt(12,:), xt_2(12,:), '$y_{\mathrm{i},32}(\tau)$', '$x_{\mathrm{i},32}(\tau)$', 'g'}
            };
