...
The research activity associated with ``Computational Quantum Engineering''
...
Journal of Computational Physics (ISSN: 2666-352X, CiteScore: 4.2, Impact Factor: 5.0)

Special Issue: ``Computational Quantum Engineering''

Website: https://www.sciencedirect.com/journal/applications-in-energy-and-combustion-science/about/call-for-papers#liquid-fuel-combustion

Editorial and charges:
...
Submission Website: https://www.editorialmanager.com/AECS/default.aspx?pg=mainpage.html, select the article type of `` VSI: Computational Quantum Engineering '' 
