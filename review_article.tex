...
\section{Recommended Foundational Literature}

The following reading material is recommended for understanding physics in
general, and quantum mechanics in particular:
\begin{itemize}
\item ``The Feynman lectures on Physics,'' Feynman, Leighton, 
 Sands\cite{feynman2011feynman}.
\item ``Electricity and Magnetism third edition,'' 
  Purcell and Morin\cite{purcell2013electricity}.
\item ``Modern Quantum Mechanics,'' 
  Sakurai and Napolitano\cite{sakurai2020modern}.
\end{itemize}
\par\noindent
At the next level, the following foundational material on 
density functional 
theory are important for understanding the state-of-the-art for
enegineering and benchmarking quantum
computers\cite{ko2023implementation}:
\begin{itemize}
\item ``A mathematical introduction to electronic structure theory,''
  Lin and Lu\cite{lin2019mathematical}.
\item ``Density-Functional theory of Atoms and Molecules,'' Parr and
 Yang\cite{ParrYang}
\item ``Modern quantum chemistry: introduction to advanced electronic
 structure theory,'' Szabo and Ostlund\cite{szabo1996modern}.
\end{itemize}


mathematics and quantum mechanics and abstract algebra and error correction
...
the electron double slit experiment\cite{bach2013controlled}, amongst many
more.
...
When discussing the engineering of quantum computers, relativistic effects do not have to be considered. Also, nonlinear Shrodinger mathematical models do not have to be considered.
