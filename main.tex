...
\item Georgadou et al Hele-Shaw simulation on quantum computer.
\item Rupert Klein WaveTrain: A Python package for numerical quantum mechanics of chain-like systems based on tensor trains
\item psiquantum.com ``Fusion based quantum computation,'' Bartolucci et al
\item Roy Goodman et al, ``QGLAB: A MATLAB PACKAGE FOR COMPUTATIONS ON QUANTUM GRAPHS''
