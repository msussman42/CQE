...
\title{Special Issue: Numerical Algorithms for the design of Quantum Computers}
...
\item
Stefanie Gunther, Lawrence Livermore National Laboratory
...
Numerical Algorithms for the optimal control of Qubit(s), computing ground states, hybrid classical and quantum algorithms, numerical methods for the unsteady/steady Schrodinger equation, nonlinear Schrodinger equation, inverse problems for the Hamiltonian, Error Correction Algorithms.

\section{Special Issue Keywords }

Quantum Computer, control of Quantum Systems, Schrodinger equation, inverse problems in Quantum Mechanics, Quantum error correction, Hybrid Quantum/Classical algorithms
...
the ``Numerical Algorithms for the design of Quantum Computers'' aspects associated with the
...
At the present, the research activity associated with ``Numerical Algorithms for the design of Quantum Computers''
...
to ``Numerical Algorithms for the design of Quantum Computers'' in one accessble issue.
...
\item Gunther, Petersson, and DuBois\cite{9651392},
  ``Quandary: An open-source C++ package for high-performance optimal control of open quantum systems''
\item Gunther and Petersson\cite{gunther2023practical},
...
Special Issue: ``Numerical Algorithms for the design of Quantum Computers''
\par\noindent
...
Submission Website: 
\par\noindent
select the article type of `` VSI: Numerical Algorithms for the design of Quantum Computers '' 
\par\noindent
